# easy_saas: Lowcode Portal (An Enhanced Web-Based PostgreSQL Client & Page Engine)

个人简单saas，简化展示，简化流程 (A simple SaaS workspace for layout configuration and dynamic database operations).
