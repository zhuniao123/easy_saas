...
public class PageControllerTest {
    ...
    public void testCrudUsesConfiguredPrimaryKey() throws Exception {
        ...
        jdbcTemplate.execute("INSERT INTO lc_query_model (query_code, anchor_entity, sql_text) VALUES ('q_supplier', 'supplier', 'SELECT supplier_id, supplier_code, supplier_name FROM biz_supplier ORDER BY supplier_id')");
